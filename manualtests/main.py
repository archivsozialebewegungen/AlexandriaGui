...
from WindowTestHelpers import EventServiceStub, ReferenceServiceStub,\
    SystematicServiceStub, DocumentServiceStub
from tkinter.constants import LEFT, TOP, END
from alexpresenters.messagebroker import MessageBroker, Message,\
    CONF_DOCUMENT_CHANGED, CONF_EVENT_CHANGED, REQ_SET_DOCUMENT, REQ_SET_EVENT,\
    ERROR_MESSAGE
...
from alexandriabase.domain import Document, InvalidDateException, Creator,\
    DocumentFileInfo
from tkgui.components.references.documentsystematicreference import DocumentSystematicReferenceView
from alexpresenters.components.references.documentsystematicreferencespresenter\
    import DocumentSystematicReferencesPresenter
from alexpresenters.dialogs.systematicpointselectionpresenter import \
    SystematicPointSelectionPresenter
from tkgui.dialogs.systematicpointselectiondialog import SystematicPointSelectionDialog
...
class FilterDialogsTest(AbstractComponentTest):
    ...
    def create_views(self):
        ...
        systematic_point_selection_presenter = SystematicPointSelectionPresenter(SystematicServiceStub())
        systematic_point_selection_dialog = SystematicPointSelectionDialog(systematic_point_selection_presenter)

        self.document_filter_dialog = DocumentFilterDialog(DocumentFilterDialogPresenter(), systematic_point_selection_dialog)
...
class TestRunner:
    ...
    def __init__(self, test_classes):
        ...
        self.widget_frame = Frame(top_frame, width=400)
    ...
    def run_selected_test(self):
        ...
        self.test_frame = Frame(self.widget_frame, width=400)
