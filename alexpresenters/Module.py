...
class PresentersModule(Module):
    ...
    def document_window_post_processors(self,
                                        document_type_post_processor: DocumentTypePostProcessor,
                                        journal_document_type_post_processor: JournalDocTypePostProcessor) -> guiinjectorkeys.DOCUMENT_WINDOW_POST_PROCESSORS_KEY:
